...
describe('ZkmeSbt', () => {
    ...
    let nftCollection: SandboxContract<ZkmeSbt>;
    ...
    beforeEach(async () => {
        ...
        nftCollection = blockchain.openContract(await ZkmeSbt.fromInit(owner.address, contentCell, NFT_PRICE));
    ...
    it('should deploy and mint the first NFT upon the first Mint message', async () => {
        ...
        const collectionData = await ZkmeSbt.getGetCollectionData();
